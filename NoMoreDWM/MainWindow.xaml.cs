...
namespace NoMoreDWM
{
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            if (!IsDotNet46Installed())
            {
                MessageBox.Show("Please install .NET Framework 4.6.0 and try again!", "Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
                Environment.Exit(1);
            }
        ...
        private bool IsDotNet46Installed()
        {
            ...
            using (RegistryKey ndpKey = Registry.LocalMachine.OpenSubKey(subkey))
            {
                if (ndpKey != null && ndpKey.GetValue("Release") != null)
                {
                    ...
                    // .NET Framework 4.6 corresponds to release key 393295 or higher
